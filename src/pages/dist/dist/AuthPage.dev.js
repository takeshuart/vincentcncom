...
var AuthPage = function AuthPage() {
  ...
  return react_1["default"].createElement(material_1.Container, {
  ...
  }, isLogin ? "欢迎回来" : "创建新账户"), react_1["default"].createElement(material_1.Typography, {
    variant: "body2",
    color: "text.secondary",
    sx: {
      mb: 4
    }
  }, isLogin ? "登录后探索更多艺术品。" : "加入我们，体验梵高数字档案。"), apiError && react_1["default"].createElement(material_1.Alert, {
    severity: "error",
    sx: {
      width: "100%",
      mb: 3
    }
  }, apiError), react_1["default"].createElement(material_1.Box, {
    component: "form",
    ...
    rules: {
      ...
      validate: {
        isEmailValid: function isEmailValid(value) {
    ...
    render: function render(_a) {
      var field = _a.field;
      return react_1["default"].createElement(material_1.TextField, __assign({}, field, {
        variant: "outlined",
        margin: "normal",
        fullWidth: true,
        id: "credential",
  ...
  }), !isLogin && react_1["default"].createElement(react_hook_form_1.Controller, {
    ...
    disabled: loading
  }, loading ? react_1["default"].createElement(material_1.CircularProgress, {
    size: 24,
    color: "inherit"
  }) : isLogin ? "登录" : "注册")), react_1["default"].createElement(material_1.Stack, {
    direction: "row",
    justifyContent: "center",
    alignItems: "center",
    sx: {
    ...
    variant: "body2",
    color: "text.secondary"
  }, isLogin ? "没有账户？" : "已有账户？"), react_1["default"].createElement(material_1.Link, {
    component: "button",
    variant: "body2",
    onClick: toggleMode,
    disabled: loading,
