    ...
    return __awaiter(this, void 0, Promise, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, requests_1["default"].get(url, config)];
                case 1:
                    res = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, requests_1["default"].get("/artworks/vincent/" + artworkId)];
                case 1:
                    response = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, requests_1["default"].get('/artworks/vincent', { params: queryParams })];
                case 1:
                    response = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, requests_1["default"].get("/artworks/vincent/surprise")];
                case 1:
                    response = _a.sent();
                    return [2 /*return*/, response.data.data];
                case 2:
...
function fetchConfigData() {
    return __awaiter(this, void 0, Promise, function () {
        var genreRes, periodRes, techniques;
        return __generator(this, function (_a) {
            try {
                genreRes = [];
                periodRes = [];
