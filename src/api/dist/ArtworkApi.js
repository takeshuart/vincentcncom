        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    _a.label = 2;
                case 2: return [4 /*yield*/, requests_1["default"].get("/artworks/vincent/" + artworkId)];
                case 3:
                    response = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    _a.label = 2;
                case 2: return [4 /*yield*/, requests_1["default"].get('/artworks/vincent', { params: queryParams })];
                case 3:
                    response = _a.sent();
