...
var AppHeader = function () {
    ...
    var _a = AuthContext_1.useAuth(), user = _a.user, logout = _a.logout, isLoading = _a.isLoading;
    var isLoggedIn = !!user;
        ...
        React.createElement(material_1.Toolbar, { sx: { bgcolor: "transparent" } },
            ...
            React.createElement(material_1.Box, { sx: { display: "flex", alignItems: "center", ml: "auto" } }, isLoading ? (React.createElement(material_1.CircularProgress, { size: 24, sx: { color: "gray" } })) : isLoggedIn ? (React.createElement(React.Fragment, null,
                ...
                React.createElement(material_1.Menu, { anchorEl: anchorEl, id: "account-menu", open: open, onClose: handleMenuClose, transformOrigin: { horizontal: "right", vertical: "top" }, anchorOrigin: { horizontal: "right", vertical: "bottom" } },
                    ...
                    React.createElement(material_1.MenuItem, { onClick: handleMenuClose },
                        React.createElement(material_1.ListItemIcon, null,
                            React.createElement(AccountCircle_1["default"], { fontSize: "small" })),
                        "\u6211\u7684\u4E3B\u9875"),
                    React.createElement(material_1.MenuItem, { onClick: handleMenuClose },
                        React.createElement(material_1.ListItemIcon, null,
                            React.createElement(Settings_1["default"], { fontSize: "small" })),
                        "\u8BBE\u7F6E"),
                    React.createElement("hr", { style: { margin: "4px 0", border: "none", borderTop: "1px solid #eee" } }),
